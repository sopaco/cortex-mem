...
### 8.1 存储URI
- **用户记忆**: `cortex://user/{user_id}/preferences/{name}.md`, `cortex://user/{user_id}/entities/{name}.md`, `cortex://user/{user_id}/events/{name}.md`
- **Agent 记忆**: `cortex://agent/{agent_id}/cases/{name}.md`, `cortex://agent/{agent_id}/skills/{name}.md`
