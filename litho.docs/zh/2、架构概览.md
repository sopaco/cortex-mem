...
| **增量更新系统** | 核心业务 | 事件驱动的增量记忆更新和级联层级同步（v2.5） | MemoryEventCoordinator、CascadeLayerUpdater、LlmResultCache |
| **记忆遗忘机制** | 核心业务 | 基于Ebbinghaus遗忘曲线的低强度记忆清理（v2.6） | MemoryCleanupService、CleanupStats |
