...
| 指标 | 描述 | 评估内容 |
|--------|------|----------|
| **MRR** (Mean Reciprocal Rank) | 第一个相关记忆排名的倒数平均值 | 排名准确性 |
...
```
📊 OVERALL RESULTS:
recall_at_1                    : 0.850 ± 0.120  (95% CI: 0.730 - 0.970)
recall_at_5                    : 0.920 ± 0.090  (95% CI: 0.810 - 1.030)
precision_at_1                  : 0.800 ± 0.140  (95% CI: 0.660 - 0.940)
mrr                             : 0.880 ± 0.100  (95% CI: 0.780 - 0.980)
ndcg_at_5                       : 0.910 ± 0.080  (95% CI: 0.830 - 0.990)
answer_semantic_similarity      : 0.905 ± 0.095  (95% CI: 0.810 - 1.000)
```

### 指标判断

| Recall@1 | Precision@1 | MRR | 整体评价 |
|----------|--------------|-----|----------|
| > 0.9 | > 0.9 | > 0.9 | 🟢 优秀 |
| 0.7-0.9 | 0.7-0.9 | 0.7-0.9 | 🟡 良好 |
| 0.5-0.7 | 0.5-0.7 | 0.5-0.7 | 🟠 一般 |
| < 0.5 | < 0.5 | < 0.5 | 🔴 需改进 |
